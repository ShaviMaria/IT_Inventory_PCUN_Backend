...
CREATE TABLE IF NOT EXISTS Tablet(
    ...
    FOREIGN KEY(Model) REFERENCES Tablet_Model(Id_Tablet_Model) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS Phone(
    ...
    FOREIGN KEY(IP_Address) REFERENCES IP_Address(IP_Address) ON UPDATE CASCADE ON DELETE CASCADE,
