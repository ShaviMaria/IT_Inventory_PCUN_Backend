...
CREATE TABLE IF NOT EXISTS Join_Cell_Phone_Event(
    ...
    FOREIGN KEY(Id_Cell_Phone) REFERENCES User(Id_Cell_Phone) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS Join_Tablet_Event(
    ...
    FOREIGN KEY(Id_Tablet) REFERENCES User(Id_Tablet) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS Join_Phone_Event(
    ...
    FOREIGN KEY(Id_Phone) REFERENCES User(Id_Phone) ON UPDATE CASCADE ON DELETE CASCADE,
